package fr.furiogamer.writemods.gui.jobs;

import fr.furiogamer.writemods.gui.atm.GuiDepAtm;
import fr.furiogamer.writemods.gui.atm.GuiRetAtm;
...
public class GuiMenuJobs extends GuiScreen {
    ...
    public GuiMenuJobs(Minecraft mc) {
        minecraft = mc;
    }

...
public class BlockPaintingRare extends Block implements IHasModel {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockPaintingRare(String name, Material material) {
        super(material);
    ...
    public void addInformation(ItemStack item, EntityPlayer player, List<String> list, boolean bool) {
        list.add(ChatFormatting.GREEN + "Tableau rare");
    }

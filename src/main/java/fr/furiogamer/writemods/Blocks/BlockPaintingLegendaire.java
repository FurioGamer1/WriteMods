...
public class BlockPaintingLegendaire extends Block implements IHasModel {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockPaintingLegendaire(String name, Material material) {
        super(material);
    ...
    public void addInformation(ItemStack item, EntityPlayer player, List<String> list, boolean par1) {
        list.add(ChatFormatting.YELLOW + "Tableau légendaire");
    }
